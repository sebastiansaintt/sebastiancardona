...
const messages = {
  en: {
    ...
    aboutTitle: 'About Me',
    aboutP1: 'Software Engineering graduate (pending degree completion) focused on Backend Development, Data Engineering and AI-driven Automation.',
    ...
    educationText: 'Software Engineering — Universidad Cooperativa de Colombia (2022 - 2026). Academic requirements completed; pending degree issuance.',
    skills: {
  ...
  es: {
    ...
    aboutTitle: 'Sobre Mí',
    aboutP1: 'Graduado en Ingeniería de Software (pendiente de expedición de título) enfocado en Desarrollo Backend, Ingeniería de Datos y Automatización impulsada por IA.',
    ...
    educationText: 'Ingeniería de Software — Universidad Cooperativa de Colombia (2022 - 2026). Requisitos académicos completados; pendiente expedición de título.',
    skills: {
      languages: 'Python, JavaScript, SQL, C#',
      backend: 'FastAPI, Django, Express.js, ASP.NET',
      databases: 'PostgreSQL, MySQL, Supabase',
    ...
    contactSub: '¿Buscas un ingeniero backend, de datos o de IA? Construyamos algo excepcional juntos.',
